          ...
          <div style="border: solid 1px black;border-radius: 30px;padding:15px">
            <el-form ref="form" :model="form" label-width="80px">
              ...
              <el-collapse v-model="activeName" accordion>
                ...
                <el-collapse-item name="1">
                  ...
                  <div
                    style="border: solid 1px #e3e3e9;border-radius: 10px;
            margin-left: 40px;box-shadow: 5px 5px 5px rgba(0.1,0.1,0.1,0.1)"
                  >
                    <el-form-item label="新密码" label-width="120px">
                      <el-input
                        v-model="form.password"
                        placeholder="请输入8-16位，且由数字，字母构成的密码"
                        show-password
            ...
            margin-left: 40px;box-shadow: 5px 5px 5px rgba(0.1,0.1,0.1,0.1)"
                ...
                <el-collapse-item name="4">
                  <template slot="title">
                    <i class="icon el-icon-copy-document" />
                    ...
                    <el-form-item label="答案" label-width="120px">
                      <el-col :span="10">
                        <el-input
                          ...
                          :disabled="''==form.securityQuestion"
